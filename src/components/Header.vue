        ...
        <div v-else class="flex justify-between  bg-white border-b border-gray-200  h-[70px] py-0 px-[30px]">
            <div class="flex items-center justify-center gap-2 py-[13px] mr-[60px]">
             ...
             <div class="flex items-center justify-center phone w-[50px] h-[50px] bg-[rgb(253,224,199)] rounded-full">
                 <svg @click="$emit('toggle-navbar')" xmlns="http://www.w3.org/2000/svg" width="24" height="26" viewBox="0 0 16 16"><g fill="black"><path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/><path d="M8 14a1 1 0 1 0 0-2a1 1 0 0 0 0 2"/></g></svg>
             </div>
             <div class="flex flex-col">
...
const checkScreenSize = () => {
  isSmallScreen.value = window.innerWidth < 768; // taille de l'écran à ajuster selon ton besoin
};
...
// Accéder à l'instance du routeur
