<template>
    <div v-if="isOpen" class="fixed inset-0 z-50 bg-black bg-opacity-50" @click="closeModal">
      ...
      <button @click="closeModal" @click.stop aria-label="Close" class="text-[#bfbfbf] justify-center items-center flex bg-white rounded-full h-[30px] w-[30px] absolute lg:right-[860px] lg:top-3 top-[15%] right-2">
